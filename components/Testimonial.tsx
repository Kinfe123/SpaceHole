      ...
      <div className="w-full mx-auto px-10">
        <div className="mb-10">
          <h1 className="heading">
            What Client <span className="text-purple">Says</span>
          </h1>
        ...
        >
          {testimonials.map((testimonial, indx) => {
            return (
              <div
                key={indx}
                className="border-[1.2px] animate-logo-cloud flex flex-col bg-page-gradient border-black/20  dark:border-white/10  rounded-lg shrink-0 grow-0 w-[600px] h-full"
              >
